...
class Detailedhistoire extends StatefulWidget {
  @override
  _DetailedhistoireState createState() => _DetailedhistoireState();
}

class _DetailedhistoireState extends State<Detailedhistoire> {
